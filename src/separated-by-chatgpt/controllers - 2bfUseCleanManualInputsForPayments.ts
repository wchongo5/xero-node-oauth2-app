...
export async function payments(req: Request, res: Response) {
  try {
    ...
    var tenantId = req.body.tenantId //"33b67fb1-e1c6-414c-bc39-c4305af2146f" // X-DIM

    var cs = req.body.invoiceNumber // "XDWFPU221001" // Cooperativa Q17
    const yy = cs.slice(6,8)
    const startDateStr = `20${yy}/01/01`

    var referenceStr = req.body.paymentReference //'XFAP5 Residência Unifamiliar / Banco'
    // var referenceStr = 'XFUP5 Plano de Pormenor / Banco'
    var accountCode = req.body.accountCode // "B01" // WALLET
    ...
    var amountNum = req.body.paymentAmount //1010
