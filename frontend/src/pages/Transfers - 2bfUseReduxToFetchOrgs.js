   ...
   <div>
      ...
      <form onSubmit={handleSubmit}>
        ...
        <div className="form-control">
          ...
          <select className="custom-select" name="bankAccountName1" onChange={handleBankAccount1Change} value={selectedBankAccount1}>
        ...
        <div className="form-control">
          ...
          <select className="custom-select" name="bankAccountName2" onChange={handleBankAccount2Change} value={selectedBankAccount2}>
            {accountCodeList.map((bankAccountName) => (
              <option key={bankAccountName[0]} value={bankAccountName[0]}>
                {bankAccountName[1]}
              </option>
