...
const Payments = () => {
  ...
  // If you need tho use calculed date, use function getMonthsAgo() in "20150101"
  // 20150101 before start Xero to ensuare that every customer of balance is included
  ...
  const handleSubmit = async (event) => {
   ...
   <div>
      ...
      <form onSubmit={handleSubmit}>
         ...
         <label>Total / Payments List (with dates) / Balance</label>
          <br />
