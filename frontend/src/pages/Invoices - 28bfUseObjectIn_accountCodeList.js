...
import { fetchTenants, fetchAccounts, fetchContactsToPay, fetchPayments, fetchInvoicesToPay } from "../redux/paymentsSlice";
import "./Invoices.css";
          ...
          <div className="form-control-finance">
            ...
            <div>
              ...
              {(selectedInvoice.amountDue != (sumAmountDueByContact(invoicesToPay))) &&
                (<div className="amount-due">Remanescente por contacto: {formatNumber(sumAmountDueByContact(invoicesToPay))}</div>)             
              }              
            </div>
          </div>
        )}
